...
$action=$_REQUEST['action'];
    ...
    <a href="<?php /*This variable caries the link as below*/echo $link_address;?>"> Send </a>
    </form>
    <?php 
    ...
    if (($No1=="")||($No2=="")||($No3=="")||($Message==""))
		...
		echo "Please fill all the films";
            ...
            $SenderID="lesapiti";
            $link_address="144.76.58.179:16243/cgi-bin/sendsms?username=senduser&password=sendpass&to=".$recepients."&from=".$SenderID."&text=".$Message."&dlr-mask=31";
